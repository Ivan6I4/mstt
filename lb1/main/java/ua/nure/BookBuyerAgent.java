...
public class BookBuyerAgent extends Agent {
    ...
    private final AID[] SELLER_AGENTS = {new AID("Eugene", AID.ISLOCALNAME),
            new AID("Alex", AID.ISLOCALNAME)};
        ...
        public void action() {
            switch (step) {
                case 0:
                    ...
                    for (AID sellerAgent : SELLER_AGENTS) {
                ...
                case 1:
                    ...
                    if (reply != null) {
                        ...
                        repliesCnt++;
                        if (repliesCnt >= SELLER_AGENTS.length) {
                            step = 2;
                        }
                    } else {
                        block();
